...
const Chat = () => {
  ...
  return (
    <div className={`nav-item absolute right-3 md:right-45 top-16 bg-white dark:bg-[#42464D] p-4 rounded-lg w-96 border border-gray-300 dark:border-gray-700 ${isOpen ? 'block' : 'hidden'}`}>
